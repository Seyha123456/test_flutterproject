...
List<PokemonModel> pokemonListModelFromJson(String str) =>
    List<PokemonModel>.from(
        json.decode(str).map((x) => PokemonModel.fromJson(x)));
String pokemonListModelToJson(List<PokemonModel> data) =>
...
class PokemonModel {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "category": category,
        "weight": weight,
        "typeofpokemon": typeofpokemon == null
            ? null
        ...
        "evolutions": evolutions == null
            ? null
            : List<dynamic>.from(evolutions!.map((x) => x)),
